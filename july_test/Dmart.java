...
public class Dmart {
  ...
  System.out.println("Enter name of item-6: ");
        String itemName6 = sc.nextLine();        System.out.println("Enter quantity for item-6: ");
        int qty6 = sc.nextInt();
        int price6 = 60;
